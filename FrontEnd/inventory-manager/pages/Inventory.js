...
export default function inventory() {
  ...
  const submitForm = async (e) => {
    ...
    axios.post("http://127.0.0.1:8000/app/inventory", { name: e.target[0].value, total: e.target[1].value, group_id: x, price: e.target[3].value, photo: e.target[4].value }, getAuthToken())
  }
